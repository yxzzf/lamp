@extends('layouts.index') @section('title') 口味列表 @endsection @section('title','口味列表') 
@section('content')
...
<div class="mws-panel grid_8">
    ...
    <form action="/admin/kow" method="get">
        ...
        <table class="mws-table">
           ...
           @foreach($kows as $k=>$v)
                <tr>
                    ...
                    <td>
                        <form action="/admin/kow/{{$v->id}}" method="post">
                            {{method_field('DELETE')}}
                            {{ csrf_field() }}
                            <a href="/admin/kow/{{$v->id}}/edit" class="btn btn-success">修改</a>
